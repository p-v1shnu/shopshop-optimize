<div class="flex flex-1 flex-col overflow-y-scroll">
  ...
  <main class="h-full overflow-y-scroll p-4 space-y-4">
    ...
    <div class="border border-gray-300 p-4 text-center text-sm font-bold space-y-4 bg-white">
      ...
      <div class="text-left font-normal space-y-4">
        <div>
          <div class="font-semibold">ວິທີຈ່າຍເງິນ</div>
          <ol>
            <li>1. ເປີດແອັບທະນາຄານເທິງມືຖື</li>
            <li>2. ສະແກນ QR Code ໃນໜ້ານີ້ ຫຼື ແຄັບເຈີ້ໜ້າຈໍ ແລ້ວອັບໂຫຼດໃນແອັບທະນາຄານເພື່ອຈ່າຍເງິນ</li>
          </ol>
        </div>
        <img src="{{ \App\Utils\AppUtil::asset('resources/images/payment-app.png') }}" class="w-full">
      </div>
    </div>
