...
@section('content')
  <div class="flex-1 py-16 px-8 space-y-4 text-center">
    {{--<h1 class="text-2xl font-bold leading-relaxed">{{ $exception ? $exception->getMessage() : 'ຂະນະນີ້ມີຜູ້ໃຊ້ຈຳນວນຫຼາຍ' }}</h1>--}}
    <h1 class="text-2xl font-bold leading-relaxed">ຂະນະນີ້ມີຜູ້ໃຊ້ຈຳນວນຫຼາຍ</h1>
