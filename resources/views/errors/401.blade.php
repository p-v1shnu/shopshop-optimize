...
@section('content')
  <div class="flex-1 py-16 px-8 space-y-4 text-center">
    {{--<h1 class="text-2xl font-bold leading-relaxed">{{ $exception ? $exception->getMessage() : 'ທ່ານບໍ່ໄດ້ຮັບອະນຸຍາດ' }}</h1>--}}
    <h1 class="text-2xl font-bold leading-relaxed">ທ່ານບໍ່ໄດ້ຮັບອະນຸຍາດ</h1>
